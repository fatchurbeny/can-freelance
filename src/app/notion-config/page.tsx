      ...
      <div className="flex min-h-[calc(100vh-56px)] flex-col md:flex-row">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white">Notion Connector</h2>

            <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1.5fr)_minmax(360px,1fr)] gap-6 xl:items-start">
              {/* Left Column Container */}
              <section className="w-full rounded-xl border border-[#f0f0f0] dark:border-[#272a34] bg-white dark:bg-[#0d0e12] divide-y divide-[#f0f0f0] dark:divide-[#272a34] shadow-none">
                ...
                {configExists && databases.length > 0 && (
                  <div className="p-5 sm:p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="bg-gray-50 dark:bg-[#16181d] border border-[#f0f0f0] dark:border-[#272a34] p-4 rounded-lg flex items-center justify-between">
                         <div className="flex items-center gap-3">
                           <div className="w-8 h-8 rounded-lg bg-[#ff5e1f]/10 text-[#ff5e1f] flex items-center justify-center">
                             <Zap className="w-4 h-4" />
                           </div>
                           <div>
                             <h4 className="font-bold text-xs font-mono text-gray-900 dark:text-white">Auto Sync</h4>
                             <p className="text-[10px] font-mono text-gray-500 dark:text-gray-400">{autoSync ? 'Enabled - Cron Endpoint Active' : 'Disabled - Scheduled Sync Paused'}</p>
                           </div>
                         </div>
                         <button
                           type="button"
              ...
              <aside className="w-full rounded-xl border border-[#f0f0f0] dark:border-[#272a34] bg-white dark:bg-[#0d0e12] divide-y divide-[#f0f0f0] dark:divide-[#272a34] shadow-none xl:sticky xl:top-8">
                ...
                {/* Section 2: Current Sync Summary */}
                {configExists && databases.length > 0 && (
                  <div className="p-5 sm:p-6 space-y-4">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className="inline-flex items-center rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-0.5 font-mono text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">
                        SUCCESS
                      </span>
                    </div>
                    ...
                    <div className="space-y-3 border-t border-[#f0f0f0] dark:border-[#272a34] pt-4 text-xs font-mono">
                      <div className="flex items-center justify-between gap-4 py-1">
                        ...
                        <span className="font-bold text-gray-900 dark:text-white uppercase tracking-wider">Auto Sync</span>
                      </div>
                      <div className="flex items-center justify-between gap-4 py-1">
                        <span className="text-gray-500 dark:text-gray-400">Sync Interval</span>
                        <span className="font-bold text-gray-900 dark:text-white">Every 24 Hours</span>
                      </div>
                      <div className="flex items-center justify-between gap-4 py-1">
                        <span className="text-gray-500 dark:text-gray-400">Status</span>
                        <span className="inline-flex items-center rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-0.5 font-mono text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">SUCCESS</span>
                      </div>
                      <div className="flex items-center justify-between gap-4 py-1">
                        <span className="text-gray-500 dark:text-gray-400">Synced At</span>
                        <span className="font-bold text-gray-900 dark:text-white">17/7/2026, 14.08.55</span>
                      </div>
                      <div className="flex items-center justify-between gap-4 py-1">
                        <span className="text-gray-500 dark:text-gray-400">Records Synced</span>
                        <span className="font-bold text-gray-900 dark:text-white">256</span>
                      </div>
                    </div>
                  </div>
                )}
