...
export default function Sidebar({ currentSyncLog }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-between px-6 py-4 bg-white dark:bg-[#111827] border-b border-[#E8E0D8] dark:border-gray-800 sticky top-0 z-40 w-full shrink-0 transition-colors">
      ...
      `}>
        ...
        <button 
          ...
          className="absolute -right-3 top-10 w-6 h-6 bg-white dark:bg-gray-800 border border-[#E8E0D8] dark:border-gray-700 rounded-full flex items-center justify-center text-gray-500 hover:text-indigo-600 shadow-sm opacity-0 group-hover:opacity-100 transition-opacity z-50 hidden md:flex"
        >
