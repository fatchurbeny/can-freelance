        ...
        <div className="absolute right-0 mt-2 w-64 rounded-xl border border-[#f0f0f0] dark:border-[#272a34] bg-white dark:bg-[#16181d] p-1.5 shadow-xl z-50 font-sans text-xs">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {account.badge && (
                      <span className={`px-1.5 py-0.5 rounded-[4px] text-[9px] font-sans font-bold ${
                        isSelected
          ...
          <div className="mt-1 pt-1 border-t border-[#f0f0f0] dark:border-[#272a34]">
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[11px] font-sans font-semibold text-[#ff5e1f] hover:bg-orange-500/10 transition-colors cursor-pointer"
            >
