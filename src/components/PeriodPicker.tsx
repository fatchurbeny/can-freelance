  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="relative pl-9 pr-8 py-2 rounded-lg border border-[#f0f0f0] dark:border-[#272a34] bg-white dark:bg-[#16181d] text-xs font-mono font-medium text-gray-900 dark:text-gray-200 hover:border-gray-300 dark:hover:border-gray-700 focus:outline-none transition-colors shadow-none cursor-pointer flex items-center gap-1.5 select-none"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 rounded-xl border border-[#f0f0f0] dark:border-[#272a34] bg-white dark:bg-[#16181d] shadow-xl z-50 py-2.5 max-h-72 overflow-y-auto font-mono text-xs">
